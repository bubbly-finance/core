...
interface IBubblyPoolActions {
    ...
    /// @dev The caller of this method receives a callback in the form of IBubblyMintCallback#BubblyMintCallback
    ...
    /// @param amountRequested How much token0 should be withdrawn from the fees owed
    ...
    /// @dev The caller of this method receives a callback in the form of IBubblyFlashCallback#BubblyFlashCallback
